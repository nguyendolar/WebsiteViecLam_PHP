            ...
            <div class="col-lg-5">
                <div class="bg-light p-3 border rounded mb-4">
                    ...
                    <ul class="list-unstyled pl-3 mb-0">
                        <li class="mb-2"><strong class="text-black">Email liên hệ: </strong> <span><?php echo $row['email'] ?></span></li>
                        <li class="mb-2"><strong class="text-black">Số điện thoại liên hệ: </strong> <span ><?php echo $row['sodienthoai'] ?></span></li>
                    </ul>
                </div>
